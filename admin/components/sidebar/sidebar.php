 ...
 * alerts, photos, announcements, settings, users).
 *
...
// Settings AND Announcements are Super Admin only - a Normal Admin never sees
// them here (each page also refuses the request - see require_super_admin() in
...
if (empty($me['is_super_admin'])) {
    unset($nav['settings'], $nav['announcements']);
